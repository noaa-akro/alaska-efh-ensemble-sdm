...
```{r eval=FALSE}
region_data_goa <- readRDS(here::here("data", "all_GOA_data_1993_2025.rds"))
...
lon <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/lon_GOA.tif")
lat <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/lat_GOA.tif")
bathy <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/bathy_GOA.tif")
btemp <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/btemp_GOA.tif")
sponge <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/sponge_GOA.tif")
coral <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/coral_GOA.tif")
pen <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/pen_GOA.tif")
phi <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/phi_GOA.tif")
aspectE <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/aspectE_GOA.tif")
aspectN <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/aspectN_GOA.tif")
bcurrentU <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/bcurrentU_GOA.tif")
bcurrentUSD <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/bcurrentUSD_GOA.tif")
bcurrentV <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/bcurrentV_GOA.tif")
bcurrentVSD <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/bcurrentVSD_GOA.tif")
tmax <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/tmax_GOA.tif")
BPI <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/BPI_GOA.tif")
curve <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/curve_GOA.tif")
rockiness <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/rockiness_GOA.tif")
slope <- terra::rast("M:/HCD/shared_hcd_projects/2028 EFH SDM/2028_Covariates/GOA/slope_GOA.tif")

raster.stack <- c(lon, lat, bathy, btemp, sponge, coral, pen, phi, aspectE, aspectN, 
                  bcurrentU, bcurrentUSD, bcurrentV, bcurrentVSD, tmax, BPI, curve, rockiness, slope)
...
species <- "j_sable"
figure.name <- "Subadult Sablefish"
```
...
gam.form <- stats::formula(paste0(species, " ~ s(lon, lat, bs = 'ds', m = c(1,.5), k=10) + 
                                  ...
                                  s(bcurrentU, bs='tp',m=1,k=4) + 
                                  s(bcurrentUSD, bs='tp',m=1,k=4) + 
                                  s(bcurrentV, bs='tp',m=1,k=4) +
                                  s(bcurrentVSD, bs='tp',m=1,k=4) +
