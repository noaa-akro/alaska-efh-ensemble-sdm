...
raster.stack <- c(lon, lat, bathy, btemp, slope, sponge, coral, pen, phi, aspectE, aspectN, 
                  bcurrentU, bcurrentUSD, bcurrentV, bcurrentVSD, BPI, curve, rockiness, slope)
names(raster.stack) <- c("lon", "lat", "bdepth", "btemp", "slope", "sponge", "coral", "pen", "phi", "aspectE", "aspectN", 
                         "bcurrentU", "bcurrentUSD", "bcurrentV", "bcurrentVSD", "BPI", "curve", "rockiness", "slope")
